        ...
        <?php if (!empty($do_an_list)): ?>
            ...
            <?php foreach ($do_an_list as $index => $do_an): ?>
                <tr>
                    ...
                    <td><?php echo $do_an['ten_de_tai']; ?></td>
                    <td><?php echo $do_an['ten_sinh_vien']; ?></td>
                    <td><?php echo $do_an['giang_vien_hd']; ?></td>
                    <td><?php echo $do_an['nam_hoc']; ?></td>
                    <td><?php echo $do_an['trang_thai']; ?></td>
                    <td><?php echo $do_an['created_at']; ?></td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
